	...
	<view class="warp">
		...
		<view class="content">
			<view class="editmap">
				...
				<view class="editmap-left">
					<view class="editmap-one">
						<view class="editmap-one-left">
							<image src="../../../static/images/编组@2x(1).png" mode=""></image>
							<text>【潮汕转运中心】，这发往【航海走转…</text>
						</view>
						
						
					</view>
					<view class="editmap-two">
						2021-03-25  12:49:49
					</view>
				</view>
				
				<view class="editmap-right">
					<image src="../../../static/images/编组@2x.png" mode=""></image>
				</view>
			</view>
