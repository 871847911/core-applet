<template>
  <view class="warp">
    ...
    <u-popup v-model="tradeShow" mode="top">
      <view class="box">
        <view class="box-one" :class="{ active: num == 0 }"> 全部 </view>
        <view class="box-one"> 金米粒 </view>
        <view class="box-one"> 房费 </view>
        <view class="box-one"> 保证金 </view>
      </view>
    </u-popup>
    ...
    <view class="content">
      <view class="list" v-for="item in 3">
        <view class="list-title"> 2021年3月 </view>
        <view class="list-order" v-for="item in 3">
