<template>
  <view class="warp">
    <view class="vr">
      ...
      <view class="vr-vr">
        <view class="vr-btn1" @click="btn(0)" :class="{ active: num == 0 }"> VR </view>
        <view class="vr-btn2" @click="btn(1)" :class="{ active: num == 1 }"> 图片 </view>
        <view class="vr-btn3" @click="gopicture" v-if="btnShow"> 1/8 </view>
      </view>
    </view>
    <view class="content">
      <!-- 地址 -->
      <view class="address">
        ...
        <view class="address-title"> 似水中餐厅｜4588元奢华8~10人度假套餐！【阿丽拉乌镇】 </view>
      ...
      <view class="address-map">
        <view class="address-map-three">
          ...
          <view class="" style="font-weight: 700"> “设施齐全 附近地铁” </view>
      ...
      <view class="recommend">
        ...
        <view class="recommend-card">
          <view class="recommend-card-left">
            <image src="../../../static/images/house.png" mode=""></image>
          </view>
          <view class="recommend-card-right">
            <view class="recommend-card-one"> 已消毒步行西湖10多分钟 近浙大 … </view>
            <view class="recommend-card-two">
              <image src="../../../static/images/1@2x(3).png" mode=""></image>
              <image src="../../../static/images/1@2x(2).png" mode=""></image>
            </view>
            <view class="recommend-card-three"> ￥<text>398</text> </view>
          </view>
        </view>
        <view class="recommend-card">
          <view class="recommend-card-left">
    ...
    <view class="footer">
      ...
      <view class="footer-two"> 立即屯卷 </view>
      <view class="footer-three" @click="goyuyue()"> 直接预约 </view>
    </view>
    <!-- 分享弹窗 -->
