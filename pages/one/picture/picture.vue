<template>
  <!-- <view class="warp">
    <view class="card">
      <view class="card-btn" @click="bind(0)" :class="{ active: num == 0 }"> 全部 8 </view>
      <view class="card-btn" @click="bind(1)" :class="{ active: num == 1 }"> 客房 3 </view>
      <view class="card-btn" @click="bind(2)" :class="{ active: num == 2 }"> 外观 1 </view>
      <view class="card-btn" @click="bind(3)" :class="{ active: num == 3 }"> 餐厅 1 </view>
      <view class="card-btn" @click="bind(4)" :class="{ active: num == 4 }"> 公共区域 3 </view>
    </view>
    <view class="house" v-if="houseShow">
      <view class="house-title"> 客房 </view>
    ...
    <view class="house" v-if="appearanceShow">
      <view class="house-title"> 外观 </view>
      <view class="house-img">
        <view class="house-img-one">
          <image src="../../../static/images/house.png" mode=""></image>
          <view class="house-img-two"> 外观 </view>
        </view>
      </view>
    </view>

    <view class="house" v-if="restaurantShow">
      <view class="house-title"> 餐厅 </view>
      <view class="house-img">
        <view class="house-img-one">
          <image src="../../../static/images/house.png" mode=""></image>
          <view class="house-img-two"> 餐厅 </view>
        </view>
      </view>
    </view>
    <view class="house" v-if="publicShow">
      <view class="house-title"> 公共区域 </view>
      <view class="house-img">
        <view class="house-img-one">
          <image src="../../../static/images/house.png" mode=""></image>
          <view class="house-img-two"> 公共区域 </view>
        </view>
        <view class="house-img-one">
          <image src="../../../static/images/house.png" mode=""></image>
          <view class="house-img-two"> 公共区域 </view>
...
<script>
  export default {
    ...
    onLoad() {
      this.webUrl = uni.getStorageSync('WEBVIEW_URL')
    },
    onUnload() {
      uni.removeStorageSync('WEBVIEW_URL') //清除url缓存
    },
    methods: {
      bind(index) {
        if (index == 0) {
