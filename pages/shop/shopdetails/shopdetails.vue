	...
	<view class="warp">
		<view class="vr">
			...
			<view class="vr-vr">
				...
				<view class="vr-btn3" @click="gopicture" >
					1/8
				</view>
			</view>
		</view>
		<view class="content">
			...
			<view class="address">
				<view class="address-money">
					...
					<view class="" style="width: 32rpx;height: 32rpx;">
						<image style="width: 32rpx;height: 32rpx;"src="../../../static/images/收藏@2x%20-%20万能看图王.png" mode=""></image>
						<view class="" style="font-size: 16rpx;color: #333;">
							收藏
						</view>
					</view>
				</view>
				<view class="address-title">
					春季男士新款棒球服男韩版潮流百搭宽松帅气夹克男装休闲上衣外套
				</view>
				<view class="address-title-one">
					【闪电发货★售后保证★七天退换】
				</view>
			...
			<view class="card">
				<view class="card-one">
					...
					<view class="card-one-center">
						白色，XL，1件，可选服务
					</view>
					<view class="card-one-right" @click="sizeShow=true">
				...
				<view class="card-one">
					...
					<view class="card-one-center">
						<view class="card-one-center-left">
							领劵
						</view>
						<view class="">
							满50元立减30元商城优惠券
					...
					<view class="card-one-right" @click="couponShow=true">
						<u-icon name="arrow-right" color="#999" size="30"></u-icon>
					</view>
				</view>
				<view class="card-one">
					...
					<view class="card-one-center">
						<u-icon name="map" color="#FF4D00" size="30"></u-icon>浙江省 杭州市 拱墅区 万科广场…
					</view>
					<view class="card-one-right" @click="editShow=true">
						<u-icon name="arrow-right" color="#999" size="30"></u-icon>
					</view>
				</view>
				<view class="card-two" >
					<view class="card-two-left">
						运费
					</view>
					<view class="card-two-right">
						¥0.00（请以提交订单时为准）
					</view>
			...
			<view class="evaluate">
				<view class="evaluate-title">
					...
					<view class="evaluate-title-left">
						商品评价
					</view>
					<view class="evaluate-title-right"@click="productreviews()">
						100+条 >
					</view>
				</view>
				<view class="content-list" v-for="item in 3">
					<view class="content-list-one">
						<view class="content-list-left">
							<view class="content-list-left-img">
								<image src="../../../static/images/位图(1).png" mode=""></image>
							</view>
							<view class="content-list-left-name">
								<view class="content-list-name">
									李***992
								</view>
								<view class="content-list-name-img">
									<view class="" v-for="item in 5">
					...
					<view class="content-list-four">
						<view class="content-list-four-left">
							快乐民宿
						</view>
						<view class="content-list-four-center">
							
						</view>
						<view class="content-list-four-right">
							白色 XL
						</view>
					</view>
					<view class="content-list-two">
						酒店地理位置好，交通方便，也有停车场。附近700米左右有地铁站，
						酒店傍边走20步左右就有一个小便利店，房间干净，住着很舒适。
						服务人员很热情，酒店提供免费的农夫山泉矿泉水。总体还是不错的，价格又很便宜的。
					</view>
					<view class="content-list-three">
						<view class="content-list-three-one" v-for="item in 3">
			...
			<view class="introduce">
				<view class="title">
					<view class="title-one" @click="bind(0)">
						<view class="title-one-left" :class="{actives:nums==0}">
							商品信息
						</view>
						<view class="title-one-right" :class="{activess:nums==0}">
							
						</view>
					</view>
					<view class="title-one"  @click="bind(1)">
						<view class="title-one-left" :class="{actives:nums==1}">
							图文描述
						</view>
						<view class="title-one-right" :class="{activess:nums==1}">
							
						</view>
					</view>
					<view class="title-one"  @click="bind(2)">
						<view class="title-one-left" :class="{actives:nums==2}">
							代买需知
						</view>
						<view class="title-one-right" :class="{activess:nums==2}">
				...
				<view class="">
					<view class="introduce-one" style="margin-top: 40rpx;">
						商品信息
					</view>
				...
				<view class="">
					...
					<view class="introduce-four">
						1、套餐有效期:有效期至2021.6.30 
					</view>
					<view class="introduce-four">
						2、使用规则:周日至周五不加价、周六加价299元/间夜, 法定节假日加价599元/间夜(春 节2021年2月10日-16日,清明节2021年4月2日-4日，劳动节2021年4月30日-5月4日，端午节2021年06月11日-06月13日)
					</view>
					<view class="introduce-four">
					...
					<view class="introduce-four">
						8、退改规则:未预约可退，预订成功后订单不可改退
					</view>
					<view class="introduce-four">
						9、开票规则:本价格含税和服务费，若客人需要发票，由酒店给客人开具发票
					</view>
					<view class="introduce-four">
						10、入住时间:当日12点之后，离店时间:次日12:00前
					</view>
					<view class="introduce-five">
				...
				<view class="">
					...
					<view class="introduce-three" style="margin: 50rpx auto 36rpx;">
					...
					<view class="introduce-four">
						若暂未确认出行日期，请选择“立即囤券”，需要使用的时 候，进入[我的] - [卡券]即可查询卡券并使用，点击[券]进入详情，点击券下方的[立即使用]按钮，即可进行使用，选择该房券适用的房型和入住/离店日期，勾选券，提交订单即可。
					</view>
				</view>
			</view>
			<!-- 超值推荐 -->
		...
		<view class="footer">
			<view class="footer-one">
				<view class="footer-one-img1">
					<image src="../../../static/images/返回首页.png" mode=""></image>
				</view>
				<view class="footer-one-title">
					首页
				</view>
			</view>
			<view class="footer-one">
			...
			<view class="footer-three" @click="gocondirmorder()">
				直接购买
			</view>
		</view>
		<!-- 配送弹窗 -->
		...
		<!-- 尺寸弹窗 -->
		<u-popup v-model="sizeShow" mode="bottom" height="1000" :closeable='true'>		
			<view class="size" >
				<view class="size-title">
					<view class="size-title-left">
						<image src="../../../static/images/house.png" mode=""></image>
					</view>
					<view class="size-title-right">
						￥<text>1688</text>
					</view>
				</view>
				<view class="size-one">
					<view class="size-one-title">
						尺码
					</view>
					<view class="size-one-list">
						<view class="size-one-list-one" v-for="item in 6">
							L
						</view>
					</view>
				</view>
				<view class="size-two">
					<view class="size-two-left">
						数量
					</view>
					<view class="size-two-right">
						<u-number-box v-model="value" @change="valChange"></u-number-box>
					</view>
				</view>
				<view class="size-three">
					确定
				</view>
			</view>
		</u-popup>
		<!-- 优惠券弹窗 -->
		<u-popup v-model="couponShow" height="800" mode="bottom" closeable='true'>
			<view class="coupon">
				<view class="coupon-title">
					优惠
				</view>	
				<view class="coupon-list" v-for="item in 3">
					...
					<view class="coupon-list-center">
						...
						<view class="coupon-list-center-bottom">
...
<script>
	export default {
		...
		methods: {
			...
			productreviews(){
				uni.navigateTo({
					url:'../productreviews/productreviews'
				})
			},
			// 跳转更多景点
			goscenicspot(){
...
<style scoped lang="scss">
			...
			.content-list{
				...
				.content-list-one{
					...
					.content-list-left{
						...
						.content-list-left-name{
							.content-list-name{
								font-size: 28rpx;
								color: #333;
							}
							.content-list-name-img{
								width: 28rpx;
								height: 28rpx;
								display: flex;
								image{
				...
				.content-list-four{
					...
					.content-list-four-left{
						
					}
					.content-list-four-center{
						width: 2rpx;
						height: 16rpx;
						background: #E6E6E6;
						border-radius: 1rpx;
	...
	.detailsShow{
		...
		.details-vr{
			position: relative;
			.details-vr-img{
				width: 686rpx;height: 400rpx;margin: auto;
				image{
					width: 686rpx;height: 400rpx
				}
			}
			.details-vr-btn{
				width: 74rpx;
