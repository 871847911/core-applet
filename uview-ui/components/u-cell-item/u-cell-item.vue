<template>
	...
	>
		...
		<i class="iconfont icon-gray u-icon-wrap u-cell__right-icon-wrap"
		 v-if="arrow" name="arrow-right" :style="[arrowStyle]"></i>
...
export default {
	...
	computed: {
		arrowStyle() {
			let style = {};
			style.color=this.iconStyle && this.iconStyle.color ? this.iconStyle.color : "#9E9E9E"
